...
const SecondSectionHome = () => {
  return (
    <>
      <div className='bg-[#EBF2FB] flex flex-col'>
        <p className='text-[#424141] pt-7 text-2xl flex justify-center'>Exclusive Offers and Discounts: Recharge and Save with Special Deals!</p>
        <div className='flex flex-row justify-center items-center h-40 space-x-24'>
          <img
